...
export const RegistrationSchema = new Schema(
  {
    ...
    hasApprovedPayment: { type: Boolean, required: false, default: false },
    attendanceStatus: {
      type: String,
    ...
    attendanceSource: { type: String, required: false },
    paymentDeferredAt: { type: Date, required: false },
    paymentDeferredBy: { type: Schema.Types.ObjectId, ref: 'User', required: false },
